...
import com.voidhub.api.service.EventService;
...
public class EventController {
    ...
    public ResponseEntity<Message> createNewEvent(@Valid @RequestBody CreateEventForm form, Principal principal) throws URISyntaxException {
